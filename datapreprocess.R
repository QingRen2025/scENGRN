...
inputdata.10x <- Read10X_h5("scENGRN/method/pbmc/data/pbmc_granulocyte_sorted_10k_filtered_feature_bc_matrix.h5")
...
frag.file <- "scENGRN/method/pbmc/data/pbmc_granulocyte_sorted_10k_atac_fragments.tsv.gz"
...
write.table(variable_genes, file = "scENGRN/method/pbmc/data/highly_variable_genes.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
head(wnn_graph)
# 保存 WNN 矩阵为 RDS 文件
saveRDS(wnn_graph, file = "scENGRN/method/pbmc/data/wnn_matrix.rds")
...
saveRDS(pbmc, file = "scENGRN/method/pbmc/data/pbmc_seurat_object.rds")
write.csv(pbmc@meta.data, "scENGRN/method/pbmc/data/wnn_meta_data.csv", quote=FALSE)
