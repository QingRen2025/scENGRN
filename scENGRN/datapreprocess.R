...
write.table(variable_genes, file = "highly_variable_genes.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
# Get the weighted nearest neighbor connectivity matrix from the WNN graph
wnn_graph <- pbmc@graphs$wsnn
saveRDS(wnn_graph, file = "wnn_matrix.rds")
